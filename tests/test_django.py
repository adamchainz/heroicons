...
def test_success_micro():
    template = Template(
        "{% load heroicons %}"
        + '{% heroicon_micro "academic-cap" size=40 class="h-4 w-4 inline" %}'
    )
